...
const rodizioResumo = () =>
  `No rodízio você tem sushis e sashimis, niguiris, hossomakis, uramakis, joys, hot rolls, entradas e pratos quentes como yakissoba e missoshirô. 🍣\n\n`+
...
export function resolve(input={}) {
  ...
  if (event==='pedido confirmado' || event==='feedback request') {
    ...
    r=result('rodizio_composicao',rodizioResumo(),
      [MENU,WA],{topic:'rodizio'});
